...
void StartDARTTASK(void const *argument);
...
void OSTaskInit()
{
    ...
    osThreadDef(darttask, StartDARTTASK, osPriorityNormal, 0, 1024);
...
__attribute__((noreturn)) void StartDARTTASK(void const *argument)
{
